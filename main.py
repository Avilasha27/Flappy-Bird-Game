...
if __name__ == "__main__":
    # This will be the main point from where our game begins
    pygame.init()  # initializes all pygame's modules
    FPSCLOCK = pygame.time.Clock()
    pygame.display.set_caption("Flappy Bird by Avilasha")
    ...
    # GAME SOUNDS
    GAME_SOUNDS["dead"] = pygame.mixer.Sound("gallery/audio/dead.wav")
